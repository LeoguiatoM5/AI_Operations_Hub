...
| `grounding-inventado` | grounding | 0.00 | 0.45 | sim |
...
| `sutil-parafrase-que-afrouxa` | grounding | 0.00 | 0.45 | sim |
| `sutil-numero-certo-coisa-errada` | grounding | 0.00 | 0.64 | sim |
| `sutil-condicao-omitida` | grounding | 0.00 | 0.64 | sim |
| `sutil-quantificador-trocado` | grounding | 0.00 | 0.64 | sim |
| `sutil-confianca-sem-lastro` | consistency | 0.66 | 0.30 | sim |
